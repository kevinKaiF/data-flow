package com.github.dataflow.dashboard;
...
public class DashboardLauncher {
    private static Logger logger = LoggerFactory.getLogger(DashboardLauncher.class);
    ...
    private static Handler getSpringHandler() {
        ...
        // config context path
        handler.setContextPath("/dashboard");
        // config session manager. By default, embedded jetty doesn't support session manager
